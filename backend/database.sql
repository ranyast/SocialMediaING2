...
-- Correction de la structure de la table friends
...
-- Correction de la structure de la table friend_requests
...
-- Correction de la structure de la table job_offers
...
CREATE TABLE IF NOT EXISTS job_offers (
  ...
  INDEX sender_username (sender_username(250)),
  INDEX receiver_username (receiver_username(250)),
  INDEX id_post (id_post)
) ENGINE=InnoDB;
...
-- Correction de la structure de la table post_likes
...
-- Correction de la structure de la table users
